...
#       05_fit.py
#
#     spin polarised dft autopilot/
#       autopilot_zgnr.py  <-- THIS FILE
#
# This script:
#   - sweeps Ny_list = [1, 2, 4, 6, 8]
#   - for each Ny, creates:
#       spin polarised dft autopilot/zgnr_sweep_results/Ny<Ny>/
...
HERE = os.path.dirname(os.path.abspath(__file__))      # .../spin polarised dft autopilot
ROOT = os.path.dirname(HERE)                           # parent containing the three folders

DFT_DIR = os.path.join(ROOT, "spin polarised dft")     # where config_zgnr + 01..05 are
